...
function ContactUs() {
  ...
  return (
    <div>
      ...
      />
      <div class="mt-6 max-w-[77rem] max-lg:max-w-4xl mx-auto bg-[#2e0249] rounded-lg">
                ...
                <div>
                    ...
                    <ul class="mt-12 space-y-8">
                        ...
                        <li class="flex items-center">
                            ...
                            <a href={`tel:${phoneNumber}`} class="text-white text-sm ml-4">
                            603-345-1376
                            </a>
                        </li>
                        <li class="flex items-center">
      ...
      <div className="space-y-4 max-lg:mt-4">
        <button type="button" className="px-4 py-2 rounded-lg bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079] mr-4">Painting</button>
        <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4">Painting</button>
        <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300">Painting</button>
      </div>
